...
const AdvancedSettings: React.FC<AdvancedSettingsProps> = ({
  ...
  const validateNumber = (_: any, value: string) => {
    ...
    if (isNaN(Number(value)) || Number(value) < 0) {
      return Promise.reject(t("modelsAndEndpoints.addModel.advanced.positiveNumber"));
    }
    return Promise.resolve();
  };

  const validateJson = (_: unknown, value: string) =>
    formItemValidateJSON(_, value).catch(() => Promise.reject(t("modelsAndEndpoints.addModel.advanced.validJson")));
  ...
  return (
    <>
      <Accordion className="mt-2 mb-4">
        <AccordionHeader>
          <b>{t("modelsAndEndpoints.addModel.advanced.title")}</b>
        </AccordionHeader>
        <AccordionBody>
          <div className="bg-white rounded-lg">
            <Form.Item
              label={t("modelsAndEndpoints.addModel.advanced.customPricing")}
              name="custom_pricing"
            ...
            <Form.Item
              label={
                <span>
                  {t("modelsAndEndpoints.addModel.advanced.knowledgeBases")}{" "}
                  <Tooltip title={t("modelsAndEndpoints.addModel.advanced.knowledgeBasesTooltip")}>
                    <a
              ...
              className="mt-4"
              help={t("modelsAndEndpoints.addModel.advanced.knowledgeBasesHelp")}
            >
              <VectorStoreSelector
                onChange={() => {}}
                accessToken={accessToken}
                placeholder={t("modelsAndEndpoints.addModel.advanced.knowledgeBasesPlaceholder")}
              />
            </Form.Item>
            ...
            <Form.Item
              label={
                <span>
                  {t("modelsAndEndpoints.addModel.advanced.guardrails")}{" "}
                  <Tooltip title={t("modelsAndEndpoints.addModel.advanced.guardrailsTooltip")}>
                    <a
              ...
              name="guardrails"
              className="mt-4"
              help={t("modelsAndEndpoints.addModel.advanced.guardrailsHelp")}
            >
              <Select
                mode="tags"
                style={{ width: "100%" }}
                placeholder={t("modelsAndEndpoints.addModel.advanced.guardrailsPlaceholder")}
                options={guardrailsList.map((name) => ({ value: name, label: name }))}
              />
            </Form.Item>

            <Form.Item label={t("modelsAndEndpoints.addModel.advanced.tags")} name="tags" className="mb-4">
              <Select
                mode="tags"
                style={{ width: "100%" }}
                placeholder={t("modelsAndEndpoints.addModel.advanced.tagsPlaceholder")}
            ...
            {customPricing && (
              <div className="ml-6 pl-4 border-l-2 border-gray-200">
                <Form.Item
                  label={t("modelsAndEndpoints.addModel.advanced.pricingModel")}
                  name="pricing_model"
                  className="mb-4"
                >
                  <Select
                    ...
                    options={[
                      { value: "per_token", label: t("modelsAndEndpoints.addModel.advanced.perMillionTokens") },
                      { value: "per_second", label: t("modelsAndEndpoints.addModel.advanced.perSecond") },
                    ]}
                  />
                </Form.Item>
                ...
                {pricingModel === "per_token" ? (
                  <>
                    <Form.Item
                      label={t("modelsAndEndpoints.addModel.advanced.inputCost")}
                    ...
                    <Form.Item
                      label={t("modelsAndEndpoints.addModel.advanced.outputCost")}
                    ...
                    <Form.Item
                      label={t("modelsAndEndpoints.addModel.advanced.cacheReadCost")}
                      name="cache_read_input_token_cost"
                      rules={[{ validator: validateNumber }]}
                      tooltip={t("modelsAndEndpoints.addModel.advanced.cacheReadTooltip")}
                      className="mb-4"
                    >
                      <TextInput placeholder={t("modelsAndEndpoints.addModel.advanced.cacheDefaultPlaceholder")} />
                    </Form.Item>
                    <Form.Item
                      label={t("modelsAndEndpoints.addModel.advanced.cacheWriteCost")}
                      name="cache_creation_input_token_cost"
                      rules={[{ validator: validateNumber }]}
                      tooltip={t("modelsAndEndpoints.addModel.advanced.cacheWriteTooltip")}
                      className="mb-4"
                    >
                      <TextInput placeholder={t("modelsAndEndpoints.addModel.advanced.cacheDefaultPlaceholder")} />
                    </Form.Item>
                  ...
                  <Form.Item
                    label={t("modelsAndEndpoints.addModel.advanced.costPerSecond")}
            ...
            <Form.Item
              label={t("modelsAndEndpoints.addModel.advanced.passThrough")}
              name="use_in_pass_through"
              valuePropName="checked"
              className="mb-4 mt-4"
              tooltip={
                <span>
                  {t("modelsAndEndpoints.addModel.advanced.passThroughTooltip")}{" "}
                  <Link href="https://docs.litellm.ai/docs/pass_through/vertex_ai" target="_blank">
                    {t("modelsAndEndpoints.addModel.advanced.learnMore")}
                  </Link>
                </span>
              }
            >
            ...
            />
            <Form.Item
              label={t("modelsAndEndpoints.addModel.advanced.litellmParams")}
              name="litellm_extra_params"
              tooltip={t("modelsAndEndpoints.addModel.advanced.litellmParamsTooltip")}
              className="mb-4 mt-4"
            ...
            <Row className="mb-4">
              ...
              <Col span={10}>
                <Text className="text-gray-600 text-sm">
                  {t("modelsAndEndpoints.addModel.advanced.litellmParamsHelp")}{" "}
                  <Link href="https://docs.litellm.ai/docs/completion/input" target="_blank">
                    {t("modelsAndEndpoints.addModel.advanced.completionCall")}
                  </Link>
                </Text>
              </Col>
            </Row>
            <Form.Item
              label={t("modelsAndEndpoints.addModel.advanced.modelInfo")}
              name="model_info_params"
              tooltip={t("modelsAndEndpoints.addModel.advanced.modelInfoTooltip")}
              className="mb-0"
              rules={[{ validator: validateJson }]}
            >
              <TextArea
