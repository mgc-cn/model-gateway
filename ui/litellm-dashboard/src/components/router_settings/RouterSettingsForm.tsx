    ...
    <div className="w-full space-y-8 py-2">
      ...
      <div className="space-y-6">
        <div className="max-w-3xl">
          <h3 className="text-sm font-medium text-gray-900">{t("routerSettings.sections.routing.title")}</h3>
          <p className="text-xs text-gray-500 mt-1">{t("routerSettings.sections.routing.description")}</p>
        </div>
