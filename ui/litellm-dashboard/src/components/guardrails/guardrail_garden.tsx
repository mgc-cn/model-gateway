  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 24 }}>
        <Input
          size="large"
          placeholder={t("guardrailManagement.garden.search")}
      ...
      <div style={{ marginBottom: 40 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
          ...
          >
            {showAllLitellm ? (
              <>{t("guardrailManagement.garden.showLess")}</>
            ) : (
              <>
                <ArrowRightOutlined style={{ fontSize: 12 }} />
                {t("guardrailManagement.garden.showAll", { count: litellmCards.length })}
              </>
            )}
          </span>
        </div>
        <p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 20px 0" }}>
          {t("guardrailManagement.garden.litellmDescription")}
        </p>
        <div
          style={{
            display: "grid",
      ...
      <div style={{ marginBottom: 40 }}>
        ...
        <p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 20px 0" }}>
          {t("guardrailManagement.garden.partnerDescription")}
        </p>
        <div
          style={{
            display: "grid",
