    ...
    >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1.5 flex-wrap">
            ...
            >
              ...
              {t(`guardrailManagement.submissions.status.${g.status}`)}
            </span>
          </div>
        ...
        <div className="flex flex-col items-end gap-2 shrink-0">
          <div className="flex items-center gap-2">
            <span className="text-xs text-gray-500 whitespace-nowrap">
              {t("guardrailManagement.submissions.forwardKey")}
            </span>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            >
              {isSelected ? t("guardrailManagement.actions.close") : t("guardrailManagement.actions.review")}
            </button>
            {g.status === "pending" && (
              <>
                <button
      ...
      <div className="mt-3 pt-3 border-t border-gray-100">
        ...
        >
          ...
          {t("guardrailManagement.submissions.staticHeaders")}
        ...
        {isHeadersExpanded && (
          <div className="mt-2">
            {g.customHeaders.length === 0 ? (
              <p className="text-xs text-gray-400 italic">{t("guardrailManagement.submissions.noStaticHeaders")}</p>
            ) : (
      ...
      <div className="p-5">
        <div className="flex items-start justify-between mb-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${teamColor}`}>
                {t("guardrailManagement.submissionDetail.team")}: {g.team}
              </span>
              <span
                className={`inline-flex items-center gap-1.5 text-xs font-medium px-2 py-0.5 rounded-full ${status.bg} ${status.text}`}
              >
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              {t("guardrailManagement.submissionDetail.submittedBy", {
                user: g.submittedBy,
                date: g.submittedAt,
              })}
            </p>
          ...
          <button
            ...
            aria-label={t("guardrailManagement.submissionDetail.closePanel")}
          >
        ...
        <div className="space-y-4">
          <ConfigRow label={t("guardrailManagement.fields.endpoint")}>
          ...
          <ConfigRow label={t("guardrailManagement.fields.method")}>
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mb-2">{t("guardrailManagement.submissions.staticHeadersHelp")}</p>
            {g.customHeaders.length === 0 ? (
              <p className="text-xs text-gray-400 italic mb-2">
                {t("guardrailManagement.submissions.noStaticHeaders")}
              </p>
            ) : (
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end">
              <input
                ...
                placeholder={t("guardrailManagement.submissions.headerName")}
              ...
              <input
                ...
                placeholder={t("guardrailManagement.submissions.value")}
                className="flex-1 min-w-0 text-xs font-mono border border-gray-200 rounded-sm px-2 py-1.5 text-gray-700 placeholder-gray-400 focus:outline-hidden focus:ring-1 focus:ring-blue-500"
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    e.preventDefault();
              ...
              >
                {t("guardrailManagement.submissionDetail.addHeader")}
              </button>
            </div>
          </div>
          <div>
            <div className="flex items-center gap-1.5 mb-2">
              <span className="text-xs font-semibold text-gray-700">
                {t("guardrailManagement.submissions.forwardHeaders")}
              </span>
            ...
            <p className="text-xs text-gray-400 mb-2">{t("guardrailManagement.submissionDetail.forwardHeadersHelp")}</p>
            {g.extraHeaders.length === 0 ? (
              <p className="text-xs text-gray-400 italic mb-2">
                {t("guardrailManagement.submissions.noForwardHeaders")}
              </p>
            ) : (
              <ul className="list-none space-y-1 mb-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder={t("guardrailManagement.submissions.forwardHeaderPlaceholder")}
                className="flex-1 min-w-0 text-xs font-mono border border-gray-200 rounded-sm px-2 py-1.5 text-gray-700 placeholder-gray-400 focus:outline-hidden focus:ring-1 focus:ring-blue-500"
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    e.preventDefault();
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            ...
            >
              <span>{t("guardrailManagement.submissions.equivalentConfig")}</span>
              {configExpanded ? (
        ...
        <div className="mt-5 pt-4 border-t border-gray-100 space-y-2">
          ...
          >
            ...
            {t("guardrailManagement.submissionDetail.testEndpoint")}
          </button>
          {g.status === "pending" && (
            <div className="flex gap-2">
              <button
              ...
              >
                ...
                {t("guardrailManagement.actions.approve")}
              </button>
              <button
                type="button"
                onClick={onReject}
              ...
              >
                <XIcon className="h-4 w-4" />
                {t("guardrailManagement.actions.reject")}
              </button>
            </div>
          )}
        </div>
    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-xl p-6 max-w-sm w-full mx-4">
        ...
        <h3 className="text-base font-semibold text-gray-900 mb-1">
          {isApprove
            ? t("guardrailManagement.submissions.approveTitle")
            : t("guardrailManagement.submissions.rejectTitle")}
        </h3>
        <p className="text-sm text-gray-500 mb-5">
          {t("guardrailManagement.submissionDetail.confirm", {
            action: isApprove ? t("guardrailManagement.actions.approve") : t("guardrailManagement.actions.reject"),
            name: guardrailName,
          })}{" "}
          {isApprove
            ? t("guardrailManagement.submissions.approveDescription")
            : t("guardrailManagement.submissions.rejectDescription")}
        </p>
        <div className="flex gap-3">
          ...
          >
            {isApprove ? t("guardrailManagement.actions.approve") : t("guardrailManagement.actions.reject")}
          </button>
        </div>
      </div>
    </div>
...
export function TeamGuardrailsTab({ accessToken }: TeamGuardrailsTabProps) {
  ...
  const fetchSubmissions = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : t("guardrailManagement.submissions.loadFailed"));
      setGuardrails([]);
    } finally {
      setIsLoading(false);
    }
  ...
  async function toggleForwardKey(id: string) {
    ...
    try {
      ...
      NotificationsManager.success(
        newValue
          ? t("guardrailManagement.submissions.forwardEnabled")
          : t("guardrailManagement.submissions.forwardDisabled"),
      );
    } catch {
      NotificationsManager.fromBackend(t("guardrailManagement.submissions.forwardFailed"));
    }
  }
  ...
  async function updateCustomHeaders(id: string, customHeaders: { key: string; value: string }[]) {
    ...
    try {
      ...
      NotificationsManager.success(t("guardrailManagement.submissions.headersUpdated"));
    } catch {
      NotificationsManager.fromBackend(t("guardrailManagement.submissions.headersUpdateFailed"));
    }
  }
  ...
  async function updateExtraHeaders(id: string, extraHeaders: string[]) {
    ...
    try {
      ...
      NotificationsManager.success(t("guardrailManagement.submissions.forwardHeadersUpdated"));
    } catch {
      NotificationsManager.fromBackend(t("guardrailManagement.submissions.forwardHeadersUpdateFailed"));
    }
  }
  ...
  async function handleApprove(id: string) {
    ...
    try {
      ...
      NotificationsManager.success(t("guardrailManagement.submissions.approved"));
    } catch {
      NotificationsManager.fromBackend(t("guardrailManagement.submissions.approveFailed"));
    }
  }
  ...
  async function handleReject(id: string) {
    ...
    try {
      ...
      if (selectedId === id) setSelectedId(null);
      await fetchSubmissions();
      NotificationsManager.success(t("guardrailManagement.submissions.rejected"));
    } catch {
      NotificationsManager.fromBackend(t("guardrailManagement.submissions.rejectFailed"));
    }
  }
    ...
    <div className="flex h-full">
      <div className={`flex-1 min-w-0 p-6 overflow-auto ${selected ? "border-r border-gray-200" : ""}`}>
        <div className="grid grid-cols-4 gap-4 mb-6">
          <StatCard label={t("guardrailManagement.submissions.total")} value={totalCount} color="text-gray-900" />
          <StatCard
            label={t("guardrailManagement.submissions.status.pending")}
            value={pendingCount}
            color="text-yellow-600"
          />
          <StatCard
            label={t("guardrailManagement.submissions.status.active")}
            value={activeCount}
            color="text-green-600"
          />
          <StatCard
            label={t("guardrailManagement.submissions.status.rejected")}
            value={rejectedCount}
            color="text-red-600"
          />
        </div>
        <div className="flex items-center gap-3 mb-5">
          <div className="relative flex-1 max-w-xs">
            ...
            <input
              type="text"
              placeholder={t("guardrailManagement.submissions.search")}
              value={search}
          ...
          >
            <option value="all">{t("guardrailManagement.submissions.status.all")}</option>
            <option value="pending">{t("guardrailManagement.submissions.status.pending")}</option>
            <option value="active">{t("guardrailManagement.submissions.status.active")}</option>
            <option value="rejected">{t("guardrailManagement.submissions.status.rejected")}</option>
          </select>
          <button
            type="button"
          ...
          >
            ...
            {t("guardrailManagement.submissionDetail.add")}
          </button>
        </div>
        <div className="space-y-3">
          {isLoading && (
            <div className="text-center py-12 text-gray-500 text-sm">
              {t("guardrailManagement.submissions.loading")}
            </div>
          )}
          {error && <div className="text-center py-12 text-red-600 text-sm">{error}</div>}
          {!isLoading && !error && filtered.length === 0 && (
            <div className="text-center py-12 text-gray-400 text-sm">{t("guardrailManagement.submissions.empty")}</div>
          )}
          {!isLoading &&
            !error &&
            filtered.map((g) => (
      ...
      <Modal
        title={t("guardrailManagement.submitForm.title")}
        ...
        okText={t("guardrailManagement.submitForm.submit")}
      >
        ...
        <Form
          ...
          onFinish={async (values) => {
            ...
            try {
              ...
              NotificationsManager.success(t("guardrailManagement.submitForm.success"));
              setIsSubmitModalOpen(false);
              submitForm.resetFields();
              fetchSubmissions();
            } catch {
        ...
        >
          <Form.Item
            label={t("guardrailManagement.submissionDetail.team")}
            name="team_id"
            rules={[{ required: true, message: t("guardrailManagement.submitForm.teamRequired") }]}
          >
            <TeamDropdown />
          </Form.Item>
          <Form.Item
            label={t("guardrailManagement.submitForm.name")}
            name="guardrail_name"
            rules={[{ required: true, message: t("guardrailManagement.submitForm.nameRequired") }]}
          >
            <Input placeholder={t("guardrailManagement.submitForm.namePlaceholder")} />
          </Form.Item>
          <Form.Item
            label={t("guardrailManagement.fields.mode")}
            name="mode"
            rules={[{ required: true, message: t("guardrailManagement.submitForm.modeRequired") }]}
          >
            <Select>
              <Select.Option value="pre_call">{t("guardrailManagement.submitForm.preCall")}</Select.Option>
              <Select.Option value="post_call">{t("guardrailManagement.submitForm.postCall")}</Select.Option>
              <Select.Option value="during_call">{t("guardrailManagement.submitForm.duringCall")}</Select.Option>
            </Select>
          </Form.Item>
          <Form.Item
            label={t("guardrailManagement.submitForm.apiBase")}
            name="api_base"
            rules={[
              { required: true, message: t("guardrailManagement.submitForm.apiBaseRequired") },
              { type: "url", message: t("guardrailManagement.submitForm.validUrl") },
            ]}
          >
            <Input placeholder="https://your-guardrail-api.com/v1/check" className="font-mono" />
          </Form.Item>
          <Form.Item
            label={t("guardrailManagement.submitForm.params")}
                ...
                validator: (_, value) => {
                  ...
                  try {
                    ...
                    if (typeof parsed !== "object" || Array.isArray(parsed)) {
                      return Promise.reject(t("guardrailManagement.submitForm.jsonObject"));
                    }
                    return Promise.resolve();
                  } catch {
                    return Promise.reject(t("guardrailManagement.submitForm.invalidJson"));
                  }
                },
              },
            ]}
          ...
          <Form.Item
            label={t("guardrailManagement.submitForm.info")}
            name="guardrail_info"
            rules={[
              {
                validator: (_, value) => {
