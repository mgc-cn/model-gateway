  ...
  return (
    <Card className="p-6">
      <Title className="text-lg font-semibold text-gray-900 mb-2">
        {t("modelsAndEndpoints.passThrough.security.title")}
      </Title>
      <Subtitle className="text-gray-600 mb-4">{t("modelsAndEndpoints.passThrough.security.description")}</Subtitle>
      {premiumUser ? (
        ...
        <div>
          <div className="flex items-center mb-3">
            ...
            <span className="ml-2 text-sm text-gray-400">{t("modelsAndEndpoints.passThrough.security.premium")}</span>
          </div>
          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <Text className="text-sm text-yellow-800">
              {t("modelsAndEndpoints.passThrough.security.enterprisePrefix")}{" "}
              <a href="https://www.litellm.ai/#pricing" target="_blank" rel="noopener noreferrer" className="underline">
                {t("modelsAndEndpoints.passThrough.security.here")}
              </a>
              .
            </Text>
          </div>
