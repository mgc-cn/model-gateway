        ...
        items={[
          {
            ...
            label: (
              <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
                <h3 className="text-lg font-medium text-gray-900">{t("observability.logs.detail.tools")}</h3>
                <Text type="secondary" style={{ fontSize: 14 }}>
                  {t("observability.logs.detail.toolsSummary", { total: totalTools, called: calledTools })}
                </Text>
                <Text type="secondary" style={{ fontSize: 14 }}>
                  • {toolNamePreview}
                  {hasMoreTools && "..."}
