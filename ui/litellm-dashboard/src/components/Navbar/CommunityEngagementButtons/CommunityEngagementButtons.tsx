...
export const CommunityEngagementButtons: React.FC = () => {
  ...
  return (
    <div
      ...
      aria-label={t("navigation.communityLinks")}
    >
      <Tooltip title={t("navigation.slackCommunity")}>
        <a
          href="https://www.litellm.ai/support"
          target="_blank"
          rel="noopener noreferrer"
          className={iconBtnClass}
          aria-label={t("navigation.joinSlack")}
        >
          <SlackOutlined className="text-lg" />
        </a>
      </Tooltip>
      <Tooltip title={t("navigation.githubCommunity")}>
        <a
          href="https://github.com/BerriAI/litellm"
          target="_blank"
          rel="noopener noreferrer"
          className={iconBtnClass}
          aria-label={t("navigation.githubCommunity")}
        >
