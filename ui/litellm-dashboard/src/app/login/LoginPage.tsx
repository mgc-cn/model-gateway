      ...
      <div className="relative min-h-screen flex items-center justify-center bg-gray-50">
        ...
        <Card className="w-full max-w-lg shadow-md">
          <Space direction="vertical" size="middle" className="w-full">
            ...
            <Alert
              message={t("login.disabledTitle")}
              description={
                <>
                  <Paragraph className="text-sm">{t("login.disabledDescription")}</Paragraph>
      ...
      <Card className="w-full max-w-lg shadow-md">
        ...
        {uiConfig?.sso_configured && (
          <Alert
            ...
            showIcon
            closable
            message={<Text>{t("login.ssoEnabled", { setting: "AUTO_REDIRECT_UI_LOGIN_TO_SSO=true" })}</Text>}
          />
        )}
      </Card>
    </div>
