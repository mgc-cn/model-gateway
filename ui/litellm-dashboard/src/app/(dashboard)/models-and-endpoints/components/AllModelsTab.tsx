...
const AllModelsTab = ({
  ...
  const handleDeleteModel = async () => {
    ...
    try {
      ...
      NotificationsManager.success(t("modelsAndEndpoints.allModels.notifications.deleted"));
  ...
  const handleTogglePause = async (modelId: string, blocked: boolean) => {
    ...
    try {
      ...
      NotificationsManager.success(
        t(
          blocked
            ? "modelsAndEndpoints.allModels.notifications.paused"
            : "modelsAndEndpoints.allModels.notifications.resumed",
        ),
      );
  ...
  return (
    <TabPanel>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <Text className="text-lg font-semibold text-gray-900">
                    {t("modelsAndEndpoints.allModels.currentTeam")}
                  </Text>
                  <div className="w-80">
                    {isLoading ? (
                        ...
                        options={[
                          {
                            ...
                            label: (
                              <Space direction="horizontal" align="center">
                                ...
                                <Text style={{ fontSize: 16 }}>{t("modelsAndEndpoints.allModels.personal")}</Text>
                              </Space>
                            ),
                          },
                          ...(teams
                ...
                <div className="flex items-center gap-4">
                  <Text className="text-lg font-semibold text-gray-900">{t("modelsAndEndpoints.allModels.view")}</Text>
                  <div className="w-64">
                    {isLoading ? (
                      <Skeleton.Input active block size="large" />
                    ) : (
                            ...
                            label: (
                              <Space direction="horizontal" align="center">
                                ...
                                <Text style={{ fontSize: 16 }}>
                                  {t("modelsAndEndpoints.allModels.currentTeamModels")}
                                </Text>
                              </Space>
                            ),
                          },
                          {
                            ...
                            label: (
                              <Space direction="horizontal" align="center">
                                ...
                                <Text style={{ fontSize: 16 }}>
                                  {t("modelsAndEndpoints.allModels.allAvailableModels")}
                                </Text>
                              </Space>
                            ),
                          },
                ...
                <div className="flex items-start gap-2 mt-3">
                  ...
                  <div className="text-xs text-gray-500">
                    {currentTeam === "personal" ? (
                      <span>
                        {t("modelsAndEndpoints.allModels.personalAccess")}{" "}
                        <a
                          href="/public?login=success&page=api-keys"
                          className="text-gray-600 hover:text-gray-800 underline"
                        >
                          {t("modelsAndEndpoints.allModels.virtualKeysPage")}
                        </a>
                      </span>
                    ) : (
                      <span>
                        {t("modelsAndEndpoints.allModels.teamAccess", {
                          team: typeof currentTeam !== "string" ? currentTeam.team_alias || currentTeam.team_id : "",
                        })}{" "}
                        <a
                          href="/public?login=success&page=api-keys"
                          className="text-gray-600 hover:text-gray-800 underline"
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="relative w-64">
                      <input
                        type="text"
                        placeholder={t("modelsAndEndpoints.allModels.searchPlaceholder")}
                    ...
                    >
                      ...
                      {t("modelsAndEndpoints.allModels.filters")}
                    </button>
                    ...
                    >
                      ...
                      {t("modelsAndEndpoints.allModels.resetFilters")}
                    </button>
                  </div>
                  ...
                  <Button
                    ...
                    title={t("modelsAndEndpoints.modelSettings.title")}
                  />
                </div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-3">
                    ...
                    <div className="w-64">
                      <Select
                        ...
                        placeholder={t("modelsAndEndpoints.allModels.publicNameFilter")}
                        showSearch
                        options={[
                          { value: "all", label: t("modelsAndEndpoints.allModels.allModels") },
                          { value: "wildcard", label: t("modelsAndEndpoints.allModels.wildcardModels") },
                    ...
                    <div className="w-64">
                      <Select
                        ...
                        placeholder={t("modelsAndEndpoints.allModels.accessGroupFilter")}
                        showSearch
                        options={[
                          { value: "all", label: t("modelsAndEndpoints.allModels.allAccessGroups") },
      ...
      <DeleteResourceModal
        ...
        title={t("modelsAndEndpoints.allModels.delete.title")}
        alertMessage={t("modelsAndEndpoints.allModels.delete.irreversible")}
        message={t("modelsAndEndpoints.allModels.delete.message")}
        resourceInformationTitle={t("modelsAndEndpoints.allModels.delete.information")}
        resourceInformation={
          modelToDelete
            ? [
                {
                  label: t("modelsAndEndpoints.allModels.delete.modelName"),
                  value: modelToDelete.model_name || t("modelsAndEndpoints.allModels.notSet"),
                },
                {
                  label: t("modelsAndEndpoints.allModels.delete.litellmModelName"),
                  value: modelToDelete.litellm_model_name || t("modelsAndEndpoints.allModels.notSet"),
                },
                {
                  label: t("modelsAndEndpoints.allModels.delete.provider"),
                  value: modelToDelete.provider || t("modelsAndEndpoints.allModels.notSet"),
                },
                {
                  label: t("modelsAndEndpoints.allModels.delete.createdBy"),
                  value: modelToDelete.model_info?.created_by || t("modelsAndEndpoints.allModels.notSet"),
                },
              ]
            : []
        }
