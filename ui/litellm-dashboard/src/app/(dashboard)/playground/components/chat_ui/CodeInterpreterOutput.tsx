          ...
          items={[
            {
              ...
              label: (
                <span className="flex items-center gap-2 text-sm text-gray-600">
                  <CodeOutlined /> {i18n.t("playground.code.executed")}
                </span>
              ),
              children: (
                <SyntaxHighlighter
        ...
        <div key={annotation.file_id} className="rounded-lg border border-gray-200 overflow-hidden">
          {loadingImages[annotation.file_id] ? (
            <div className="flex items-center justify-center p-8 bg-gray-50">
              ...
              <span className="ml-2 text-sm text-gray-500">{i18n.t("playground.code.loadingImage")}</span>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center justify-between px-3 py-2 bg-gray-50 border-t border-gray-200">
                ...
                >
                  <DownloadOutlined /> {i18n.t("playground.code.download")}
                </button>
              </div>
            </div>
          ) : (
            <div className="flex items-center justify-center p-4 bg-gray-50">
              <span className="text-sm text-gray-400">{i18n.t("playground.code.imageUnavailable")}</span>
            </div>
          )}
        </div>
      ))}
