  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <FilterInput
          placeholder={t("organizationManagement.filters.name")}
        ...
        <FiltersButton
          ...
          label={t("organizationManagement.filters.show")}
        />

        <ResetFiltersButton onClick={onReset} label={t("organizationManagement.filters.reset")} />
      </div>
      ...
      {showFilters && (
        <div className="flex flex-wrap items-center gap-3 mt-3">
          <FilterInput
            placeholder={t("organizationManagement.filters.id")}
